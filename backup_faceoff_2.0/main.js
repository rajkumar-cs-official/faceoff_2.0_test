...
// async function processDeepfakeV2(formData) {
//     try {
//             const response = await fetch('/process_deepfake_v2/', {
//                 method: 'POST',
...
//             const deepfakeV2Section = document.getElementById('deepfake-v2-section');
//             if (deepfakeV2Section) {
//                 deepfakeV2Section.style.display = 'block';
//             }

//             document.getElementById("deepfake-v2-result").innerHTML = `
//                 <div class="results-container">
//                     <div class="overall-metrics">
//                         <h3 class="content-heading">Deepfake Result</h3>
...
//                         <h3 class="graph-heading">Deepfake Trend Analysis</h3>
//                         <img id="deepfakeGraphv2" src="${data.curve_graph}" alt="Deepfake Trend Graph" loading="lazy">
//                     </div>
//                     <div class="graph-container">
//                         <h3 class="graph-heading">Deepfake Detection Distribution</ch3>
//                         <img id="deepfakeGraphv21" src="${data.pie_chart}" alt="Deepfake Trend Graph" loading="lazy">
//                     </div>
//                     <div class="graph-container">
//                         <h3 class="graph-heading">Frame Count</h3>
//                         <img id="deepfakeGraphv22" src="${data.bar_graph}" alt="Deepfake Trend Graph" loading="lazy">
//                     </div>
//                 </div>
//             `;
//             // Removed matchContainerHeights();
...
async function processAudioTone(formData) {
    try {
        const response = await fetch('/process_audio_tone/', {
            method: 'POST',
        ...
        document.getElementById("audio-tone-result").innerHTML = `
                <div class="results-container">
                    <div class="overall-metrics">
                        <h3 class="content-heading">Audio Tone</h3>
        ...
        // Removed matchContainerHeights();
        // if (!data.error) {
        //     accuracyScores.audio = data.avg_confidence; // Store the average confidence score
        //     trustScores.audio = data.trust_score;
        // }
    } catch (error) {
        console.error('Error:', error);
        document.getElementById("status").innerText = `Error: ${error.message}`;
        ...
        if (selectedModule) {
            switch (selectedModule) {
                ...
                case 'audio':
                    ...
                    await processAudioTone(formData);
            ...
            // // updateAccuracyDisplay(overallAccuracy);
            // // updateTrustStars(calculateTrustScore());
