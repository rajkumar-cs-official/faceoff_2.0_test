...
from .views import Deepfake, Home, UploadVideo, Posture, Eye, Face, AudioTone, HeartRate, HRV, Speech, EyeAnalysisView
...
#    path('calculate-scores/', CalculateScores.as_view(), name='calculate_scores'),
